 ...
 */
/* copyright --> */
#ifndef D_SOCKET_OPS_H
#define D_SOCKET_OPS_H
...
inline void closeSocket(sock_t socket) { ::close(socket); }
#endif

std::string errorMsg(int error);
void applySocketBufferSize(sock_t socket);

} // namespace aria2::socket_ops
#endif // D_SOCKET_OPS_H
