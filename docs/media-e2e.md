...
| [Shaka live HLS](https://storage.googleapis.com/shaka-live-assets/player-source.m3u8) | Refresh, pause/resume, explicit finish | Record 60 s | 10 MB |
| [DASH-IF live DASH](https://livesim2.dashif.org/livesim2/testpic_2s/Manifest.mpd) | Availability, refresh, recording limit | Record 90 s | 4 MB |
...
focused rerun. The executable is copied into the run directory so a Windows build
